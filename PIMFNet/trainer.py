...
class PIMFuseTrainer(pl.LightningModule):
    def __init__(self, args,label_names):
        ...
        self.test_labels = []
        self.test_pairs = []
        self.test_feats = {k: [] for k in ['feat_vibration_shared', 'feat_vibration_distinct','feat_pressure_shared', 'feat_pressure_distinct','y_256']}
        self.test_attns = []
    ...
    def pressure_pulsation_model(self, params, data):
        ...
        dict1 = {0: 17, 1: 35, 2: 52, 3: 70, 4: 86, 5: 104, 6:121, 7: 138, 8: 156, 9: 173, 10:190, 11: 208}
        dict2 = {0: 259, 1: 517, 2: 778, 3: 1046, 4: 1297, 5: 1555, 6: 1809, 7: 2064, 8: 2324}#S2
        ...
        for n in range(len(dict2)):
            ...
            a1 = 2 / 5120 * (b[:, n:n + 1] + c[:, n:n + 1] * torch.cos(2 * np.pi * 17 * t))
    ...
    def custom_loss(self, model_output):
        ...
        reconstructed_signal = self.pressure_pulsation_model(model_output['fused_30'], ddd)
